...
namespace Vector3
{
	...
	{
		return(XMVectorGetX(XMVector3AngleBetweenVectors(XMLoadFloat3(&xmf3Vector1), XMLoadFloat3(&xmf3Vector2))));
	}
	...
	{
		XMFLOAT3 temp;
		XMStoreFloat3(&temp,XMVector3TransformCoord(XMLoadFloat3(&xmf3Vector), XMLoadFloat4x4(&xmmtx4x4Matrix)));
		return temp;
	}
}
...
namespace Plane
{
	extern XMVECTOR lowPlane;
	extern XMVECTOR highPlane;
	extern XMVECTOR leftPlane;
	extern XMVECTOR rightPlane;
