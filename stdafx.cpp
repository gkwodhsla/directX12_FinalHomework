...
XMVECTOR Plane::lowPlane = XMPlaneFromPointNormal(XMVectorSet(0.0f, -100.0f, 0.0f, 1.0f), XMVectorSet(0.0f, 1.0f, 0.0f, 1.0f));
XMVECTOR Plane::highPlane = XMPlaneFromPointNormal(XMVectorSet(0.0f, 180.0f, 0.0f, 1.0f), XMVectorSet(0.0f, 1.0f, 0.0f, 1.0f));
XMVECTOR Plane::leftPlane = XMPlaneFromPointNormal(XMVectorSet(-150.0f, 0.0f, 0.0f, 1.0f), XMVectorSet(-1.0f, 0.0f, 0.0f, 1.0f));
XMVECTOR Plane::rightPlane = XMPlaneFromPointNormal(XMVectorSet(130.0f, -100.0f, 0.0f, 1.0f), XMVectorSet(-1.0f, 0.0f, 0.0f, 1.0f));
